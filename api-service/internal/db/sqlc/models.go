...
import (
	...
	types "github.com/m1thrandir225/galore-services/internal/db/types"
...
type Cocktail struct {
	...
	Ingredients  types.IngredientDTO `json:"ingredients"`
...
type GeneratedCocktail struct {
	...
	Instructions types.AiInstructionDto `json:"instructions"`
	Ingredients  types.IngredientDTO    `json:"ingredients"`
	CreatedAt    time.Time              `json:"created_at"`
}
