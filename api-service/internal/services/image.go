...
// StableDiffusionGenerator is a implementation of the ImageService interface.
...
// NewStableDiffusionGenerator returns an instance of the ImageService interface.
