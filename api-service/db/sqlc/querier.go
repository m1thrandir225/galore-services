...
type Querier interface {
	...
	CreateImageGenerationRequest(ctx context.Context, arg CreateImageGenerationRequestParams) (GenerateImageRequest, error)
	...
	GetCocktailDraft(ctx context.Context, id uuid.UUID) (GenerateCocktailDraft, error)
	...
	GetIncompleteUserGenerationRequests(ctx context.Context, userID uuid.UUID) ([]GenerateCocktailRequest, error)
	...
	UpdateGenerateCocktailRequest(ctx context.Context, arg UpdateGenerateCocktailRequestParams) (GenerateCocktailRequest, error)
