...
from internal.services import MigrateService, ParseService
...
async def update_cocktails(
    ...
    parser = ParseService(settings.parser_url, settings.parser_single_url)
    migrator = MigrateService(url=settings.api_url, api_key=settings.api_key)
